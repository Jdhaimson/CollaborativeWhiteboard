...
public class ServerProtocolTest {
    ...
    // new basic board
    @Test
    public void makeNewBoardBasicTest() throws IllegalArgumentException, IOException, InterruptedException{
    ...
    // multiple new boards
    @Test
    public void makeMultipleNewBoardBasicTest() throws IllegalArgumentException, IOException, InterruptedException{
        Server server = new Server(4444);
        ServerProtocol protocol = new ServerProtocol(null, server);
    ...
    @Test
    public void makeErrorNewBoardBasicTest() throws IllegalArgumentException, IOException, InterruptedException{
        Server server = new Server(4444);
        ServerProtocol protocol = new ServerProtocol(null, server);
    ...
    @Test
    public void makeErrorMultipleNewBoardBasicTest() throws IllegalArgumentException, IOException, InterruptedException{
        Server server = new Server(4444);
        ServerProtocol protocol = new ServerProtocol(null, server);
    ...
    @Test
    public void MultipleErrorAndCorrectNewBoardBasicTest() throws IllegalArgumentException, IOException, InterruptedException{
        Server server = new Server(4444);
        ServerProtocol protocol = new ServerProtocol(null, server);
    ...
    public void basicSwitchBoardTest() throws IOException {
        ...
        assertEquals("switch user board1 board2",output);
    ...
    public void addMultipleDifferentUsersCheckAndAddUserTest() throws IOException {
            Server server = new Server(4444);
            ServerProtocol protocol = new ServerProtocol(null, server);
            server.newBoard("board");
    ...
    public void addSameUserMultipleTimesCheckAndAddUserTest() throws IOException {
            Server server = new Server(4444);
            ServerProtocol protocol = new ServerProtocol(null, server);
            server.newBoard("board");
    ...
    public void addSameUserDifferentBoardCheckAndAddUserTest() throws IOException {
            Server server = new Server(4444);
            ServerProtocol protocol = new ServerProtocol(null, server);
    ...
    public void addSameAndDifferentUsersCheckAndAddUserTest() throws IOException {
            Server server = new Server(4444);
            ServerProtocol protocol = new ServerProtocol(null, server);
    ...
    @Test
    public void invalidInputNewBoardBasicTest() throws IllegalArgumentException, IOException, InterruptedException{
        Server server = new Server(4444);
        ServerProtocol protocol = new ServerProtocol(null, server);
